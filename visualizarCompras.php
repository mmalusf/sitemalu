        ...
        <?php
            ...
            if(isset($_SESSION['logado']) && $_SESSION['logado'] === true){
                ...
                if($tipoUsuario == 'cliente'){
                    ...
                    if($totalCompras > 1){
                        echo "<div class='alert alert-info text-center'>Voce possui <strong>$totalCompras</strong> compras registradas!</div>";
                    }
                    elseif($totalCompras == 1){
                        echo "<div class='alert alert-info text-center'>Voce possui <strong>$totalCompras</strong> compra registrada!</div>";
                    }
                    else{
                        echo "<div class='alert alert-info text-center'>Voce <strong>ainda não possui</strong> compras registradas!</div>";
                    }
